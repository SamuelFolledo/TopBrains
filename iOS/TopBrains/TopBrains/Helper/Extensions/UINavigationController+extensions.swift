...
///Change the background color of the status bar and if isLightContent
    func setStatusBarColor(backgroundColor: UIColor = SettingsService.shared.mainColor, isLightContent: Bool = true) {
        if #available(iOS 13, *) {
            ...
            navBarAppearance.titleTextAttributes = [.foregroundColor: SettingsService.shared.grayColor]
            let titleAttributes = [
                NSAttributedString.Key.foregroundColor: SettingsService.shared.grayColor,
